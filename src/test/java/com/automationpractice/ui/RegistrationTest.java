...
public class RegistrationTest {
    ...
    @ParameterizedTest
    @MethodSource
    public void registrationTest (String email, String gender, String firstName, String lastName) {
        ...
        if(fillEmailFieldAndClickcreateAnAccountButtonReturnMessage.equals("Syntax correct for Email"))
            System.out.println(createAnAccountPage.fillingPersonalInformationAndAddressAndClickRegisterButton(gender, firstName, lastName));
    }
    @AfterEach
    ...
    static String[][] registrationTest () {
        return new String[][]{
          new String[]{"karol@sss.pl","M","Michal","Wisnia2"},
          new String[]{"karol@sss.pl","W","Iwona","Poranek1"},
        };
    }
